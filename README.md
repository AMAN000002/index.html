   ...
   <div class="main">
    ...
    <div class="music-player">
         <div class="album">
            ...
            <div class="left-side">
                <img src="./card3img.jpeg" class="pic">
            </div>

            <div class="boxx">
                <p class="text-1">Silent ocean</p>
                <p class="text-2">Mere pass tum ho</p>
            </div>
            <div class="heart-folder">
                <i class="fa-regular fa-heart" class="heart"></i>
                <i class="fa-regular fa-rectangle-list" class="rect"></i>
            </div>
         </div>
         <div class="player">
         ...
         <div class="playback-bar">
            ...
            <input type="range" min="0" max="100"  class="progress-bar" step="1" style="width: 70%;">
             <span class="tot-time">3:35</span>
         </div>
    </div>
    <div class="controls"> 
        <div class="last-playback">
            <i class="fa-brands fa-square-youtube"></i>
            <i class="fa-solid fa-microphone"></i>
            <i class="fa-solid fa-bars"></i>
            <i class="fa-solid fa-user"></i>
            <i class="fa-sharp fa-regular fa-volume-high"></i>
            <input type="range" min="1" max="100" step="1" class="range-right">
        </div>
         </div>
   </div>
</body>
